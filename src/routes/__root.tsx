...
import tabletDashboardPolishCss from "../tablet-dashboard-polish.css?url";
import desktopSidebarCss from "../desktop-sidebar.css?url";
import dashboardPortalCss from "../dashboard-portal.css?url";
import dashboardCardsIconsCss from "../dashboard-cards-icons.css?url";
import ipadShellCss from "../ipad-shell.css?url";
import mobileTabletTripCardCss from "../mobile-tablet-trip-card.css?url";
